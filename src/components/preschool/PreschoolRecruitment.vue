<template>
    <main class="preschool-recruitment-container white">
        <div
          v-if="isAuth"
          class="edit-btn"
        >
...
<script>
  ...
  export default {
      ...
      data() {
        return {
          recruitment: null,
          recruitmentType: 'preschool-recruitment',
          dialog: false,
          loading: false,
        }
      },
      created() {
        this.getPreschoolRecruitment();
      },
      computed: {
...
<style lang="scss" scoped>
    .preschool-recruitment-container {
        width: 100%;
        height: 100%;
        margin-top: 15px;
        margin-bottom: 15px;
